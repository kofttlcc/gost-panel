...
export default function DelayPage() {
    ...
    const [form, setForm] = useState<SourceForm>({
        id: null, name: '', host: '', protocol: 'TCPING', port: 443
    });
    ...
    const handleAdd = () => {
        ...
        setIsEdit(false);
        setForm({ id: null, name: '', host: '', protocol: 'TCPING', port: 443 });
        setErrors({});
    ...
    const handleEdit = (s: DelayTestSource) => {
        ...
        setIsEdit(true);
        setForm({ id: s.id, name: s.name, host: s.host, protocol: s.protocol, port: s.port });
        setErrors({});
        setDialogVisible(true);
    };

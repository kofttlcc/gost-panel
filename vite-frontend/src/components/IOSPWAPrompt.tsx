...
import { IconDeviceMobile } from '@tabler/icons-react'; // Placeholder icon if tabler is used, we'll try to use raw SVG
...
export function IOSPWAPrompt() {
    ...
    return (
        <div className="fixed bottom-4 left-4 right-4 z-50 flex justify-center pb-safe">
            <Card className="max-w-md w-full shadow-2xl border border-default-200">
                <CardBody className="p-4 flex flex-row items-center justify-between gap-4">
                    ...
                    <Button size="sm" variant="light" color="danger" onPress={dismissPrompt} isIconOnly>
